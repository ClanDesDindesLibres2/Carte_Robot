...
void loop() 
{
  ...
  delay(500);
  for(int z =0; z<3;z++){
  dxl_wb.goalPosition(scanned_id[z], (int32_t)0);
  dxl_wb.goalPosition(scanned_id[z+1], (int32_t)0);
  delay(5000);
  dxl_wb.goalPosition(scanned_id[z], (int32_t)3000);
  dxl_wb.goalPosition(scanned_id[z+1], (int32_t)3000);
  delay(5000);
  }
}
